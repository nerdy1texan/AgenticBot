...
async def test_alternative_api():
    ...
    # Try different approaches to pass the message
    approaches = [
        # Try with a different structure
        ("Dict with role", {"role": "user", "content": test_query}),
        
        # Try with a list structure
        ("List structure", [{"role": "user", "content": test_query}]),
        
        # Try with a different field name
        ("Dict with input", {"input": test_query}),
        
        # Try with a different field name
        ("Dict with query", {"query": test_query}),
